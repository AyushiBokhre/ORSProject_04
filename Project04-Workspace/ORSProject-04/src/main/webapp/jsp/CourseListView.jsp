			...
			<div class="card border-0 shadow-lg rounded-4">
				...
				<div class="card-body p-4">
					...
					<div class="text-center mb-4">
						...
						<div class="mb-2">
							<i class="bi bi-book text-primary" style="font-size: 42px;"></i>
						</div>

						<h3 class="fw-bold text-dark mb-0">Course List</h3>
					...
					<div class="position-absolute top-0 end-0 mt-2 me-3">
						...
						<a href="<%=ORSView.COURSE_REPORT_CTL%>?type=pdf" target="_blank"
						...
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-5">
								...
								<div class="input-group">
									...
									<span class="input-group-text bg-white border-end-0"> <i
										class="bi bi-clock text-primary"></i>
									</span> <input type="text" name="duration" value=""
										class="form-control border-start-0"
