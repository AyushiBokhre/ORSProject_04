...
<body class="bg-light">
    ...
    List<VoterBean> list = ServletUtility.getList(request);
    ...
    <form action="<%=ORSView.VOTER_LIST_CTL%>" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a
                                            href="<%=ORSView.VOTER_CTL + "?id=" + bean.getId()%>"
